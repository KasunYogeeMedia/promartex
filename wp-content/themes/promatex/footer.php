        ...
        <div class="footer-section">
            <div id="footer-content" class="footer">
                <div class="container-fluid">
                    <div class="row footer-top mt-4 p-3">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            ...
                            <p>
                                <a href="about-us#location" class="text-black">Store Locations</a>
                            </p>
                            <p>
                                <a href="#!" class="text-black mb-4">Careers</a>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <h6>STORE</h6>
                            <p>
                                <a href="#!" class="text-black">Woman</a>
                            </p>
                            <p>
                                <a href="#!" class="text-black">Men</a>
                            </p>
                            <p>
                                <a href="#!" class="text-black">Speakers</a>
                            </p>
                        </div>

                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <h6>FOLLOW US</h6>
                            <p>And get Free Shipping on all yours orders!</p>
                    ...
                    <div class="footer-bottom text-center">
                        ...
                        <!-- <button type="button" class="btn1 mb-4 mr-1"><span>Your email address</span></button> -->
                        <input type="text" name="" id="" placeholder="Your email address">
                        <button type="button" class="btn2 mb-4"><span>Sign Up</span></button>
                    </div>
                </div>
            </div>
