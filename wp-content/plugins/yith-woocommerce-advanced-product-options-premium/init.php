 ...
 *
 * Copyright 2012-2022 - Your Inspiration Themes - All right reserved.
 *
...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '3.1.0' );
! defined( 'YITH_WAPO_SCRIPT_VERSION' ) && define( 'YITH_WAPO_SCRIPT_VERSION', '3.2.1' );
! defined( 'YITH_WAPO_DB_VERSION' ) && define( 'YITH_WAPO_DB_VERSION', '3.0.0' );
...
! defined( 'YITH_WAPO_SECRET_KEY' ) && define( 'YITH_WAPO_SECRET_KEY', '83a5bb0e2ad5164690bc7a42ae592cf5' );
