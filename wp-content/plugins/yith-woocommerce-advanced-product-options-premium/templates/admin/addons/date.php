					...
					<div class="slot" style="margin-bottom: 10px;">
						...
						yith_plugin_fw_get_field(
							array(
								...
								'class'   => 'micro select_from wc-enhanced-select',
								'type'    => 'select',
						...
						yith_plugin_fw_get_field(
							array(
								...
								'class'   => 'micro select_from_min wc-enhanced-select',
								'type'    => 'select',
						...
						<div class="field time-slot-to">
							...
							yith_plugin_fw_get_field(
								array(
									...
									'class'   => 'micro select_to wc-enhanced-select',
									'type'    => 'select',
						...
						yith_plugin_fw_get_field(
							array(
								...
								'class'   => 'micro select_to_min wc-enhanced-select',
								'type'    => 'select',
