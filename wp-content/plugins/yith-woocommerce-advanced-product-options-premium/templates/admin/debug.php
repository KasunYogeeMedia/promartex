		...
		<div class="yith-plugin-fw-panel-custom-tab-container">
			...
			<div class="fields">
				...
				margin-bottom: 10px">
					...
					<!-- Option field -->
					<div class="field-wrap">
						<label for="option-characters-limit"><span style="font-size: 15px"><b>STEP 2 - </b></span>Restart database options to test migration':</label>
						<div class="field">
							<a href="admin.php?page=yith_wapo_panel&tab=debug&wapo_action=control_debug_options&option=db_options&nonce=<?php echo esc_attr( $nonce ); ?>" class="yith-update-button">
								Restart database options
							</a>
							<span class="description"><?php echo wp_kses_post( 'DB options:<br><b>yith_wapo_db_update_scheduled_for</b> to 2.0.0
						<b>yith_wapo_db_version_option</b> to 2.0.0
						' ); ?></span>
						</div>
					</div>
					<!-- End option field -->
